...
1. **Lag features are critical**: Predicting with lagged features contributes more than a single weather feature
2. **Practical impact**: 67% MSE reduction translates to more reliable air quality forecasts
